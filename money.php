   ...
   <h2 style="text-align: center; color: aliceblue;"> CUSTOMER DETAILS</h2>
    ...
    <div class="container" style="margin-left: 180px">
                    ...
                    <tbody>
                      ...
                      <tr style="color :aqua;">
                        ...
                        <td><a href="users.php?id= <?php echo $rows['id']; ?>">
                          <button class="btn btn-outline-dark btn" style="align-items: center">View and Transact</button>
                        </a></td>
                      </tr>
                      <?php
                            }
        ...
        <div class="row text-center">
            <div class="col text-center">
                <div class="table-responsive-sm">
					<table width="93%" border="3" style="align-content: center ; align-items: center; background-color: #B7B7B7; margin-right: 20px" class="table table-hover table-striped table-sm">
  <tbody>
    <tr bgcolor="#f4c2c2">
    ...
    <tr>
      <td>1</td>
      <td>Bharat Singh</td>
      <td>Bharatsingh.tn@gmail.com</td>
    </tr>
    <tr>
      <td>2</td>
      <td>Murali krishnan</td>
      <td>muralikrishnan@gmail.com</td>
    </tr>
    <tr>
      <td>3</td>
      <td>Smrithi Prakash </td>
      <td>smrithiprakash@gmail.com</td>
    </tr>
    <tr>
      <td>4</td>
      <td>Sneha T</td>
