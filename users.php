...
<body background="background/finance-icons-blue-finance-background-currency-icons-money-background-currency-concepts-besthqwallpapers.com-1024x768.jpg">
  ...
  <div class="wrapper">
    ...
    <class class="welcome">
        <h1 align="center" style="color: #FF0004; margin-left: 200px">
 ...
 <div class="container" style="margin-left: 150px">
        <h2 class="text-center pt-4" style="color : black; color: #E5FF00" align="center" >    Customer Details</h2>
	           <?php
                include 'connect.php';
                $sid=$_GET['id'];
        ...
        <div>
            <table  class="table table-striped table-hover" style="background-color: #B7B7B7">
                <tr style="color : black; background-color: #f4c2c2" class="table-primary">
                    <th width="5%" class="text-center">Id</th>
                    <th width="10%" class="text-center">Name</th>
                    <th width="10%" class="text-center">Email</th>
                    <th width="10%" class="text-lg-start">Balance</th>
                </tr>
                <tr style="color : black">
                    ...
                    <td class="text-right py-2"><?php echo $rows['balance'] ?></td>
                </tr>
            </table>
        </div>
       <h2 class="text-center pt-4" style="color : black;">&nbsp;</h2>
        <label style="color : black; margin-left:50px"><strong>Transfer To:</strong></label>
        <select name="to" class="form-control" required style="margin-left: 50px">
        ...
        <br>
        <br>
            <label style="color : black; margin-left: 50px"><strong>Amount:</strong></label>
            <input type="number" class="form-control" name="amount" required style="margin-left: 50px">   
            <br><br>
                <div class="text-center">
                <button class="btn btn-outline-dark mb-3" name="submit" type="submit" id="myBtn" style="background-color: aliceblue">Fill the Amount and Transfer</button>
            </div>
        </form>
    </div>    
    ...
    <div class="foot">
        <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
                © 2021 Copyright - Made Bharat Singh T N:
