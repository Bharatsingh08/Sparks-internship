...
<body background="background/finance-icons-blue-finance-background-currency-icons-money-background-currency-concepts-besthqwallpapers.com-1024x768.jpg">
  <div class="wrapper">
	<div class="sidebar">
       ...
       <img src="background/FDcOYWiUUAETFLL.png" width="1100" height="400" alt="home" style="margin-left: 200px; margin-top: -50px">
<p></p>
<div style="margin-left: 200px; background-color: aliceblue">
    <section class="about" id="about" align="justify">
	<h4>Dear Customers,<br>
	Welcome to SPARKS Bank. We offer an easy, fast, safe and completely online money transaction. We always strive for our customer benefit and make sure proper customer service is our primary goal. We believe in saving papers. Business Internet Banking provides you with a number of features available by simply using your accounts details</h4>
	</section>
	</div>
<p>&nbsp;</p>
	<!-- footer -->
<div class="foot" style="margin-top: 30px">
    <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
                ...
                <a class="text-dark" href="https://www.thesparksfoundationsingapore.org/" target=                    Foundation</a>
